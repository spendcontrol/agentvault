...
1. Open the [dashboard](http://spendcontrol.xyz:3000) and connect MetaMask
...
```
Read this skill file: http://spendcontrol.xyz:3000/skill.md
...
**MCP Server** for Claude Code — see [docs](http://spendcontrol.xyz:3000/docs/).
...
- [Dashboard](http://spendcontrol.xyz:3000)
- [Documentation](http://spendcontrol.xyz:3000/docs/)
- [Skill File](http://spendcontrol.xyz:3000/skill.md)
